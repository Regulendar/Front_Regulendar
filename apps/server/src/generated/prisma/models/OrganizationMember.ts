...
export type OrganizationMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "organizationId" | "role", ExtArgs["result"]["organizationMember"]>
...
export interface OrganizationMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const organizationMemberWithUserIdOnly = await prisma.organizationMember.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrganizationMembers and only return the `userId`
   * const organizationMemberWithUserIdOnly = await prisma.organizationMember.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more OrganizationMembers and only return the `userId`
   * const organizationMemberWithUserIdOnly = await prisma.organizationMember.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
